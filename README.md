...
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/Yashwanth1124/TodoApp?color=%23b624ff)
![GitHub License](https://img.shields.io/github/license/Yashwanth1124/TodoApp?color=%23b624ff)
...
- **📥 Import/Export Tasks**: Users can import and export tasks to/from JSON files. This feature allows users to back up their tasks or transfer them to other devices easily. [Example Import File](https://github.com/Yashwanth1124/TodoApp/blob/main/example-import.json)
...
- Clone the repository: `git clone https://github.com/Yashwanth1124/TodoApp.git`
